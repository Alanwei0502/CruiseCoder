...
<<<<<<< HEAD
                echo $result[0]['mCC'] . ",loginSuccess".",".$nickname.",".$countC_Point.",".$newSignIn.",".$number;
=======
...
<<<<<<< HEAD
            echo $result[0]['mCC'] . ",loginSuccess1".",".$nickname.",".$countC_Point.",".$newSignIn.",".$number;
=======

                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                if (loginString == "NoAccount") {
                                    ...
                                    document.cookie = `user =${loginAccount};unumber =${number}; expires= ${date} ${months[month]} ${year} 15:59:59 GMT`;
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                if (loginString == "NoAccount") {
                                    ...
                                    document.cookie = `user =${loginAccount};unumber =${number}; expires= ${date} ${months[month]} ${year} 23:59:59 GMT`;
                                    // var my_cookies = document.cookie.substring(5);
